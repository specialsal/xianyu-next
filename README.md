...
本项目采用 [GNU Affero General Public License v3.0 (AGPLv3)](https://www.gnu.org/licenses/agpl-3.0.html) 开源协议。

### 协议要点

- **自由使用**：您可以自由使用、修改和分发本项目
- **开源义务**：如果您修改了本项目并在网络上提供服务，必须公开您的源代码
- **相同协议**：分发的衍生作品必须采用相同的AGPLv3协议
- **专利授权**：贡献者授予用户专利使用权

### 完整协议文本

详见 [LICENSE](LICENSE) 文件或访问 [GNU AGPLv3 官方页面](https://www.gnu.org/licenses/agpl-3.0.html)。
